...
# **🥞 PancakeSwap Prediction BETA – 2022 🥞**

![PancakeSwap-Logo-Big](pancake.png)


This bot wins the majority of rounds on PancakeSwap & CandleGenie based.
Do note that this bot is still in beta.
## ❤️ Our thanks:

BOT is free-to-use, but you are welcome to appreciate my work ☺️

ETH - 0x4B56Cfe3349f10d1e5F7aC5De55FAf5C44A6E774

BNB - 0x4B56Cfe3349f10d1e5F7aC5De55FAf5C44A6E774  
...
- Type ``cd PancakeSwap-Prediction-Bot-BETA`` (replace with your cloned/downloaded bot folder)
- Type ``npm i``
